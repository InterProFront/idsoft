<li class="group" data-group-id="{{$item_acc_adv->id_field}}">
    <div class="title-block">
        ...
        <button type="button" class="any_delete" data-block="accounting_block" data-group="acc_adv"
    ...
    <div class="block ">
        <div class="field-wrap">
            ...
            <textarea type="text" data-field-type="text" data-field-name="card_text" data-block="accounting_block" data-group="acc_adv"
                   data-item-id="{{$item_acc_adv->id_field}}" class="input group_field">{{$item_acc_adv->card_text_field}}</textarea>
        </div>
                ...
                <div class="drag-n-drop">
                    ...
                    <div class="img-hide-block">
                        <input type="hidden" class="prefix" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->prefix}}">
                        <input type="hidden" class="original_link" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->original_link}}">
                        <input type="hidden" class="preview_link" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->preview_link}}">
                        <input type="hidden" class="primary_link" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->primary_link}}">
                        <input type="hidden" class="secondary_link" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->secondary_link}}">
                        <input type="hidden" class="icon_link" data-field-name="card"
                               data-group="acc_adv" data-field-type="image"
                               data-item-id="{{$item_acc_adv->id_field}}" data-block="accounting_block"
                               value="{{$item_acc_adv->card_image->icon_link}}">
                    </div>
                    ...
                    <div class="action-block">
                        <input type="text" placeholder="alt текст" class="alt-text"
                               value="{{$item_acc_adv->card_image->alt}}"
                               data-item-id="{{$item_acc_adv->id_field}}" data-field-name="card"
                        ...
                        <label class="file-input">
                            ...
                            <input type="file" accept="image/*" class="input_file group_field"
                                   ...
                                   data-block="accounting_block" data-group="acc_adv"
                                   data-item-id="{{$item_acc_adv->id_field}}" data-entity="groupitem">
                        </label>
                    </div>
                </div>
            </div>
