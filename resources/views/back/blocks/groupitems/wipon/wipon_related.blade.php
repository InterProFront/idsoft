<li class="group" data-group-id="{{$wipon_related->id_field}}">
    <div class="title-block">
        ...
        <div class="field-wrap ">
            ...
            <input type="text" data-field-type="string" data-field-name="about_item" data-block="wipon"
                   ...
                   value="{{$wipon_related->about_item_field}}"
                   data-item-id="{{$wipon_related->id_field}}" placeholder="Строка">
        </div>
        <div class="field-wrap ">
            ...
            <select type="number" data-field-type="numb" data-field-name="product" data-block="wipon"
                    data-group="wipon_related" data-item-id="{{$wipon_related->id_field}}"
                    class="input-field group_field"
                    placeholder="Целое число" >
                @foreach($related as $r_item)
                        @if($r_item->id_field == $wipon_related->product_field)
        ...
        <div class="field-wrap buttons_block">
            <div class="col-1-2">
                <button type="button" class="any_delete button dark" data-block="wipon" data-group="wipon_related"
                        data-entity="groupitem" data-item-id="{{$wipon_related->id_field}}"
