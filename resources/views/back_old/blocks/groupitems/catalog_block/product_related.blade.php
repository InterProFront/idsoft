<li class="group" data-group-id="{{$item_product_related->id_field}}">
    ...
    <div class="block ">
        <div class="field-wrap ">
            ...
            <input type="number" data-field-type="numb" data-field-name="related" data-block="catalog_block"
                   data-group="product_related" data-item-id="{{$item_product_related->id_field}}"
                   class="input-field group_field" value="{{$item_product_related->related_field}}"
                   placeholder="Целое число">
            <select data-field-type="numb" data-field-name="product" data-block="clients_block"
                    data-group="client_related" data-item-id="{{$item_product_related->id_field}}"
