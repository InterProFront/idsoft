...
<div class="col-1-2"><button type="button" class="any_delete button dark" data-block="main_menu" data-group="menu" data-entity="groupitem" data-item-id="{{$item_menu->id_field}}" data-descr="Эл. первой группы">Удалить</button>
